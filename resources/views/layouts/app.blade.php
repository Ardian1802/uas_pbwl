...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('icons/ptp.png')  }}" type="image/x-icon">
    <!-- Fonts -->
    ...
    <style>
        ...
        .navbar {
            background-color: #4A6FDC; /* Warna biru, sesuaikan dengan preferensi Anda */
        }
        ...
        body {
            font-family: 'Nunito', sans-serif;
            background-color: #f3f3f3; /* Warna abu-abu yang sedikit lebih gelap */
        }
        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('icons/ptp.png')  }}" alt="Logo" class="logo">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/peserta') }}">Peserta</a>
                                    <a class="dropdown-item" href="{{ url('/evaluasi') }}">Evaluasi</a>
